...
namespace Badger6502VMTest
{
	...
	public:
		...
		TEST_METHOD(TEST_EOR_ABS_X_CROSSPAGE)
		{
			VM vm(true);
			CPU* cpu = vm.GetCPU();
			uint16_t addr = 0x1000;
		...
		TEST_METHOD(TEST_EOR_ABS_Y_CROSSPAGE)
		{
			VM vm(true);
			CPU* cpu = vm.GetCPU();
			uint16_t addr = 0x1000;
		...
		TEST_METHOD(TEST_EOR_I_ZP_Y_CROSSPAGE)
		{
			VM vm(true);
			CPU* cpu = vm.GetCPU();
			uint16_t addr = 0x1000;
