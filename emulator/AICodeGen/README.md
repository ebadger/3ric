...
| [`spacewar`](spacewar) | STAR DUEL — two-player mixed-hi-res gravity war: rotate/thrust/fire around a central sun with wrap, SNES pads or a split keyboard, and first-to-5 scoring. | `$0800` |
