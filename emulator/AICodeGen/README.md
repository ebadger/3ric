...
| [`blocks`](blocks) | BLOCK DROP — original lo-res colour falling-block stacker: move, rotate, and soft-drop the seven four-cell shapes to clear full rows, with a text HUD for score and controls. **A/D** move, **W** rotate, **S** drop. | `$0800` |
