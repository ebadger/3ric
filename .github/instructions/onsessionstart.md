...
You are starting a session on **3RIC** — A from-scratch 65C02 homebrew computer (Badger6502) — built gate-up and documented so anyone can build the hardware or boot it in a browser.
...
3. **Trace all layers** — Hardware → ROMs → VM core → Hosts (WinUI · Web) → Disk — for any memory-map / I/O / ROM change. (§1–2)
